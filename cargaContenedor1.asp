...
<tr>
<td align="center">
<a href="/index.asp" target="_self"><input type="button" name="vuelve" value="VOLVER AL INICIO" style="FONT-SIZE: 20pt; border: 5px solid; [b]FONT-FAMILY: Verdana, boldt[/b];
BACKGROUND-COLOR: #C0C0C0"></a>
</td>
</tr>
</table>
